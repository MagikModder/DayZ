...
import dayz.client.model.modelbase.MowzieModelBase;
import dayz.client.model.modelbase.MowzieModelRenderer;
import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;
import net.minecraft.util.MathHelper;

public class ModelCrawler extends MowzieModelBase
{
	MowzieModelRenderer Head;
	MowzieModelRenderer Torso;
	MowzieModelRenderer Left_arm;
	MowzieModelRenderer Spine_1;
	MowzieModelRenderer Left_rib_1;
	MowzieModelRenderer Right_rib_1;
    MowzieModelRenderer Right_rib_2;
    MowzieModelRenderer Left_rib_2;
    MowzieModelRenderer Spine_2;
    MowzieModelRenderer Right_arm;

    public ModelCrawler()
    {
        textureWidth = 128;
        textureHeight = 64;
        Head = new MowzieModelRenderer(this, 30, 0);
        Head.addBox(0.0F, 0.0F, 0.0F, 8, 8, 8);
        Head.setRotationPoint(-4F, 14F, -11.5F);
        Head.setTextureSize(128, 64);
        Head.mirror = true;
        setRotation(Head, 0.0F, 0.0F, 0.0F);
        Torso = new MowzieModelRenderer(this, 34, 17);
        ...
        Left_arm = new MowzieModelRenderer(this, 59, 17);
        ...
        Spine_1 = new MowzieModelRenderer(this, 44, 29);
        ...
        Left_rib_1 = new MowzieModelRenderer(this, 49, 30);
        ...
        Right_rib_1 = new MowzieModelRenderer(this, 37, 30);
        ...
        Right_rib_2 = new MowzieModelRenderer(this, 37, 33);
        ...
        Left_rib_2 = new MowzieModelRenderer(this, 51, 33);
        ...
        Spine_2 = new MowzieModelRenderer(this, 44, 33);
        ...
        Right_arm = new MowzieModelRenderer(this, 17, 17);
    ...
    private void setRotation(MowzieModelRenderer MowzieModelRenderer, float f, float f1, float f2)
    {
    	MowzieModelRenderer.rotateAngleX = f;
        MowzieModelRenderer.rotateAngleY = f1;
        MowzieModelRenderer.rotateAngleZ = f2;
    }
