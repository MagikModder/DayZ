	...
	ModelBase model = new ModelBiped();
	   ...
	   public GuiMainMenuDayZ()
	    ...
	    public void initGui()
	    {
	        ...
	        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, i + 72 + 12, 98, 20, I18n.format("Configure", new Object[0])));
	        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, i + 72 + 12, 98, 20, I18n.format("Exit", new Object[0])));
	    ...
	    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
	    {
	        ...
	        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("Change Server", new Object[0])));
