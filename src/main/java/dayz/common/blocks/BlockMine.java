...
//    @Override
  //  public boolean canPlaceBlockAt(World world, int xCoord, int yCoord, int zCoord)
    //{
      //  return super.canPlaceBlockAt(world, xCoord, yCoord, zCoord) && canThisPlantGrowOnThisBlockID(world.getBlock(xCoord, yCoord - 1, zCoord));
    	//}

 //   protected boolean canThisPlantGrowOnThisBlockID(int blockId)
  //  {
    //    return blockId == Blocks. || blockId == Block.dirt.blockID || blockId == Block.tilledField.blockID || blockId == Block.sand.blockID;
    //}
